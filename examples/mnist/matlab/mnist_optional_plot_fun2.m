function plot_stats = mnist_optional_plot_fun(net, simparams, fun, did_objfun_improve_this_iter, f, trial_idxs, forward_pass_T, ...
    forward_pass_s, v_inputtrain_T, v_inputtrain_s, v_inputtest_t, ...
...
[~,midxs_labels] = max(m_targettrain_T{1});
